...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/06 18:21:20 by user              #+#    #+#             */
/*   Updated: 2022/05/06 18:21:20 by user             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_map_errors(t_slg *slg)
{
	...
	if (slg->c < 1 || slg->k < 1)
		ft_error("Wrong number of collectibles or enemy");
}
